        ...
        <>
          ...
          <div className="flex flex-row sm:flex-col gap-1">
            <button
              ...
              className="flex-1 sm:flex-initial px-2 py-1 border-2 border-green-600 text-green-600 hover:bg-green-600 hover:text-white transition-colors font-mono font-bold text-xs flex items-center justify-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              disabled={isSubmitting || !voterName.trim()}
              className="flex-1 sm:flex-initial px-2 py-1 border-2 border-red-600 text-red-600 hover:bg-red-600 hover:text-white transition-colors font-mono font-bold text-xs flex items-center justify-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed"
            >
